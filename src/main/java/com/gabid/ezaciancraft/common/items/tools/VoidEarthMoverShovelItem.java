...
import static com.gabid.ezaciancraft.api.EzacianCraftGeneralLang.UNLOCALE_VOID_TERRA_SHATTER_SHOVEL;
...
public class VoidEarthMoverShovelItem extends ItemSpade implements IWarpingGear, IRepairable, IEzacianTool {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
        EzacianToolHelper.placerInArea(stack, player, world, x, y, z, side, 2);
        return false;
    }
