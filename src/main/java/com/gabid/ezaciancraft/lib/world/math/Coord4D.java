package com.gabid.ezaciancraft.lib.world.math;
...
//interesting api-lib class from meka meka
//https://github.com/mekanism/Mekanism/blob/1.7.10/src/main/java/mekanism/api/Coord4D.java
